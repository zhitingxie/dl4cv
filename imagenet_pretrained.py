...
# initialize the input image shape (224x224 pixels) along with the preprocessing function
inputShape = (224,224)
...
# loading our the network weights from disk
print("[INFO] loading {} ...".format(args["model"]))
Network = MODELS[args["model"]]
# instantiate the CNN with the pre-trained ImageNet weights
model = Network(weights="imagenet")

# load the input image using the keras helper utility while ensuring
# the image is resized to 'inputShape', the required input dimensions for the ImageNet pre-trained network
